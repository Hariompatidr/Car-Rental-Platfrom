...
const Hero = () => {
  ...
  const {pickupDate, setPickupDate , returnDate, setReturnDate , navigate} = UserAppContext();
  ...
  return (
    ...
    className="h-screen flex flex-col items-center justify-center gap-14 bg-light text-center">
      ...
      className="text-4xl md:text-5xl font-semibold">Welcome to Car Rental Service</motion.h1>
      <motion.form
