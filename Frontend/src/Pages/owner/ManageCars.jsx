...
const ManageCars = () => {
  ...
  const {isowner,axios , currency} = UserAppContext(); 
  ...
  const deleteCar = async (carId) =>{
    try{
      ...
      const isConfirmed = window.confirm('Are you sure you want to delete these car')
  ...
  return (
    <div className='px-4 pt-10 md:px-10 w-full'>
      <Title title="Manage Cars" subTitle="View and manage your listed cars, including editing car details, updating availability, and removing cars from listing."/>
