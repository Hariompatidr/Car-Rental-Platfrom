...
const Navbar = ({setShowLogin}) => {
  ...
  const menuLinks = [
    { name: "Home", path: "/" },
    { name: "Cars", path: "/about" },
    { name: "My Bookings", path: "/services" },
  ];
  ...
  return (
    ...
    xl:px-32 py-4 text-gray-600 border-b border-borderColor relative transition-all ${location.pathname === "/" &&"bg-light"}`}>
      ...
      <div className="flex max-sm:flex-col items-start sm:items-center gap-6">
            ...
            <button className="cursor-pointer px-4 py-1 bg-primary hover:bg-primary-dull transition-all text-white rounded-lg" >Login</button>
        </div>
